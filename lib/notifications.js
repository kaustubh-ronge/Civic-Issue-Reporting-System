...
// Relies on EMAIL_USER and EMAIL_PASS environment variables
const transporter = nodemailer.createTransport({
    service: 'gmail', // You can use other services like 'smtp.mail.yahoo.com', or generic SMTP settings
    auth: {
        user: process.env.EMAIL_USER,
        pass: process.env.EMAIL_PASS, // This should be an App Password, not your real password
    },
})
...
async function sendEmailNotification(userEmail, subject, htmlContent) {
    if (!process.env.EMAIL_USER || !process.env.EMAIL_PASS) {
        console.warn("Nodemailer: Missing EMAIL_USER or EMAIL_PASS environment variables. Email not sent.");
        return null;
    }
