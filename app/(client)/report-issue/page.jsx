            ...
            <div className="container mx-auto px-6 md:px-12 relative z-10">
                <div className="grid lg:grid-cols-12 gap-16">
                    ...
                    <div className="lg:col-span-5 lg:sticky lg:top-32 h-fit space-y-10">
                        ...
                        <div className="space-y-8 relative before:absolute before:left-4.75 before:top-2 before:bottom-2 before:w-0.5 before:bg-linear-to-b before:from-orange-500/50 before:to-transparent">
                            {[
